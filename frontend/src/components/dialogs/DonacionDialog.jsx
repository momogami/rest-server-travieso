...
import { obtenerPrendasDonacion, agregarDonacion } from "../../services/services";

const DonacionDialog = ({ isOpen, onClose, onError, onSuccess }) => {
  ...
  const fetchOptions = async () => {
    const response = await obtenerPrendasDonacion();
  ...
  const onSubmit = async () => {
    try {
      const response = await agregarDonacion({
        ropa: selectedPrenda,
        cantidad: cantidad,
      });
  ...
  return (
    ...
    >
      ...
      >
        <Typography>Donación</Typography>
